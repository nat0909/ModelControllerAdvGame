...
class HelperFunctions():
    ...
    # TODO: remove this function, the code was implemented into enemy.move_towards
    def closest_excluding(num: int, excluded: list, start_num: int, distance: int) -> int | None:
        ...
        Args:
            ...
            start_num: The starting position; cannot equal num.
        ...
        # Option 2
        reachable_positions = {}
        for cur_pos in range(start_num - distance, start_num + distance + 1):
            if cur_pos not in excluded:
                reachable_positions[(abs(cur_pos - num), abs(cur_pos - start_num))] = cur_pos
